...
/// DoH テンプレートも同様に公式発表値 (Cloudflare は標準/Security/Family でホスト名が異なる点に注意。
/// security./family. サブドメインを標準の cloudflare-dns.com と取り違えるとフィルタが効かない DoH
/// 接続になってしまう。https://developers.cloudflare.com/1.1.1.1/setup/ で確認)。
/// </summary>
